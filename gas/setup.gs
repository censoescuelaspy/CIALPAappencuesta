...
function seedConfig() {
  ...
  const defaults = [
    ...
    ['FINAL_REPORT_EMAIL', 'censoescuelaspy@gmail.com', 'Destinatario automatico del PDF y metadatos del cierre completo.', 'cierre', 'true', ''],
    ['ADMIN_NOTIFICATION_EMAIL', 'censoescuelaspy@gmail.com', 'Destinatario automatico de altas de usuarios y solicitudes de relevamiento.', 'contacto', 'true', ''],
...
function _setupSheetsConfigV21_() {
  return [
    ...
    { name: SHEET_NAMES.INCIDENCIAS, headers: ['id_incidencia', 'id_escuela', 'usuario', 'fecha_hora', 'tipo_incidencia', 'descripcion', 'prioridad', 'estado_resolucion', 'evidencia_url', 'id_sesion', 'codigo_local', 'nombre_escuela', 'departamento', 'distrito', 'localidad', 'latitud', 'longitud', 'notificacion_email_estado', 'notificacion_email_destino', 'notificacion_email_error', 'notificacion_email_fecha'] },
    { name: SHEET_NAMES.APP_FEEDBACK, headers: ['id_comentario','fecha_hora','usuario','nombre_usuario','rol','categoria','modulo','prioridad','titulo','descripcion','pasos_reproduccion','url','app_version','user_agent','viewport','estado','respuesta_admin','usuario_admin','fecha_resolucion'] },
    { name: SHEET_NAMES.EVIDENCIAS, headers: ['id_evidencia','fecha_hora','usuario','archivo_nombre','mime_type','tamano_bytes','drive_file_id','drive_url','folder_id','subfolder_id','label','school_code','school_name','scope','block_label','floor_label','space_label','element_type','element_label','element_id','field_path'] },
