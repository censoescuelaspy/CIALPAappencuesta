      ...
      sections: [
        {
          ...
          fields: [
            ...
            { id: 'cantidad_plantas', label: 'Cantidad de pisos / plantas integradas', type: 'number', required: true, min: 0, step: 1, hint: 'Un bloque puede estar sin pisos cargados. Agregue cada piso desde el plano cuando corresponda.' },
