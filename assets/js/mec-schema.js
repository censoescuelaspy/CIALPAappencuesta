  ...
  modules: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          fields: [
            { id: 'cercado_presencia', label: 'Presencia del cercado', type: 'radio', required: true, options: ['Si, completo', 'Si, incompleto', 'No'] },
        ...
        },
        {
          ...
          fields: [
            ...
            { id: 'rampas_exteriores', label: 'Rampas para personas con discapacidad', type: 'radio', required: true, options: ['Si, cumple norma INTN', 'Si, no cumple', 'No'] },
            { id: 'desague_pluvial', label: 'Sistema de desague de aguas de lluvia', type: 'radio', required: true, options: ['Si, canalizado', 'Si, cielo abierto', 'No'] },
          ],
        },
        {
          id: 'seguridad',
          ...
          fields: [
            ...
            { id: 'extintores_cantidad', label: 'Extintores contra incendio', type: 'number', min: 0, step: 1 },
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          fields: [
            { id: 'tiene_sanitarios', label: 'El local cuenta con banos o instalaciones sanitarias', type: 'radio', required: true, options: ['Si', 'No'] },
        ...
        },
        {
          ...
          fields: [
            ...
            { id: 'tipo_internet', label: 'Tipo de conexion', type: 'select', visibleWhen: { field: 'servicios.tiene_internet', equals: 'Si' }, options: ['Fibra optica', 'ADSL', 'Movil 4G/3G', 'Satelital', 'Radioenlace', 'Otro'] },
    ...
    },
    {
      id: 'electricidad',
      title: 'Electricidad',
      description: 'Estructura del modulo detectada. Implementacion detallada pendiente.',
      status: 'planned',
      sections: [],
    },
    {
